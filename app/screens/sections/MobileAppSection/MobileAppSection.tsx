    ...
    <section className="flex  items-center justify-between gap-8 py-[131px] px-[158px] max-[1100px]:py-[80px] max-[1000px]:py-[40px] max-[1300px]:px-[100px] max-[1100px]:px-[50px] max-[767px]:px-[25px] w-full bg-white ">
      <div className="flex flex-col items-start gap-10 w-[536px]  max-[1000px]:items-center max-[1000px]:w-[100%] max-[680px]:gap-5">
        <div className="flex flex-col max-[1000px]:items-center space-y-6">
          <h2 className="text-[50px] w-[313px] max-[1000px]:w-[100%] max-[1000px]:text-center font-bold text-defaultblack font-['WorkSans'] leading-[100%] max-[1100px]:text-[36px] max-[767px]:text-[28px] max-[900px]:w-[100%]">
            Download mobile app
          </h2>

          <p className="text-base font-normal text-[#00000099] m-0 font-['WorkSans'] leading-6 max-[767px]:text-[14px] max-[1000px]:text-center">
      ...
      <div className="relative w-[427px] h-[527px] max-[1100px]:h-[427px] flex  max-[1000px]:hidden">
              <img src="/group 11.png" className="absolute  left-0  w-full h-full object-contain" alt="" />
              <img src="/group 11.png" className="absolute right-[171px] top-[69px] max-[1100px]:right-[160px] max-[1100px]:top-[50px] z-50 w-full h-full object-contain" alt="" />
