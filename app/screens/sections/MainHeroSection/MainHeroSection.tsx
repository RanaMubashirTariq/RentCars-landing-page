...
const CustomDropdown2 = ({
  ...
  return (
    <section className="relative bg-white flex mt-[-30px]  flex-col items-center px-[150px] max-[1500px]:px-[72px] py-0 w-full max-[1100px]:px-[50px] max-[680px]:px-[25px] max-[680px]:mt-[-60px]">
      <div className="flex flex-col items-start justify-center w-full h-[660px] max-[1000px]:h-auto bg-[#5937e0] rounded-[40px] overflow-hidden px-[72px] max-[1000px]:py-5 relative   max-[1000px]:px-[40px] max-[1000px]:px-[20px] max-[680px]:px-[10px] max-[680px]:mt-[10px]  mt-[10px] max-[680px]:rounded-[20px]">
